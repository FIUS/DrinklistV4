...
export const ADMIN_PRIVILEGIEN = "Admin privilegien";
export const ADMIN_PRIVILEGIEN_GEAENDERT = "Admin privilegien geändert";
...
export const ERFOLGREICH_RUECKGAENIG_GEMACHT = "Erfolgreich rückgängig gemacht";
...
export const FALSCHES_PASSWORT = "Falsches Passwort oder Benutzername";
export const FAVORITEN = "Favoriten";
export const FEHLER = "Fehler";
export const FERTIG = "Fertig";
export const FLASCHENZAHL = "Bestand";
...
export const GESAMT_UMSATZ_GETRAENKE = "Gesamtumsatz (Getränke)";
...
export const SORTIERINDEX = "Sortierung";
export const SORTIERINDEX_GEAENDERT = "Sortierindex geändert";
...
export const PASSWOERTER_AENDERN = "Passwörter ändern";
export const PASSWORD_MIN_LAENGE = "Mindestens {0} Zeichen";
export const PASSWORT = "Passwort";
export const PASSWORT_AENDERN = "Passwort ändern";
...
export const STATISTIKEN = "Statistiken";
export const SUCHE_DOT_DOT_DOT = "Suche...";
export const TOP_10_GETRAENKE = "Top 10 Getränke";
...
export const UMSATZ = "Umsatz";
export const VERKAUFT = "Verkauft";
export const UMSATZ_NACH_WOCHENTAG = "Umsatz nach Wochentag";
...
export const LOW_BALANCE_TITLE = "Niedriger Kontostand";
export const LOW_BALANCE_MESSAGE = "Bitte lade dein Guthaben auf.";
export const LOW_BALANCE_BALANCE_TEXT = "Dein Kontostand liegt bei {0}€, Limit {1}€.";
export const LOW_BALANCE_DEPOSIT_AMOUNT = "Empfohlener Einzahlungsbetrag: {0}€";
export const LOW_BALANCE_QR_BANK = "Banküberweisung";
export const LOW_BALANCE_QR_PAYPAL = "PayPal";
export const LOW_BALANCE_NO_QR = "Keine Zahlungsdaten konfiguriert.";
...
export const EVENT_MODE = "Event Mode";
export const EVENT_MODE_DISABLED = "Event Mode ist deaktiviert. Bitte EVENT_MODE im Backend aktivieren.";
export const EVENT_MODE_DEAKTIVIERT = "Deaktiviert";
export const EVENT_KASSE = "Kasse";
export const EVENT_GAST = "Gast";
export const EVENT_ZUSAMMENFASSUNG = "Zusammenfassung";
export const EVENT_QR_CODE = "QR Code";
export const EVENT_QR_ANZEIGEN = "QR Code anzeigen";
export const EVENT_DRUCKEN = "Drucken";
export const EVENT_NEUER_GAST = "Neue Guthabenkarte anlegen";
export const EVENT_MARKE_KAUFEN = "Guthaben aufladen";
export const EVENT_RESTGELD_AUSZAHLEN = "Restgeld auszahlen";
export const EVENT_GAST_CODE = "Gast QR Code";
export const EVENT_SCANNEN = "Guthabenkarte Scannen";
export const EVENT_MANUELL = "Code manuell eingeben";
...
export const EVENT_RESTBETRAG_BAR = "Restbetrag Bar";
export const EVENT_ZAHLUNG_BESTAETIGEN = "Zahlung bestätigen";
export const EVENT_ZAHLUNG_GUTHABEN = "Aus Guthaben";
export const EVENT_ZAHLUNG_BAR = "Barbetrag";
export const EVENT_BESTAETIGEN = "Bestätigen";
export const EVENT_QR_VERSION_FALSCH = "Falsche QR-Version";
export const EVENT_QR_CODE_UNGUELTIG = "QR Code ungültig";
export const EVENT_GAST_GELADEN = "Gast geladen";
export const EVENT_GAST_ANGELEGT = "Gast angelegt";
export const EVENT_EINKAUF_ERFOLG = "Einkauf abgeschlossen";
export const EVENT_EINZAHLUNG_ERFOLG = "Einzahlung erfasst";
export const EVENT_AUSZAHLUNG_ERFOLG = "Auszahlung erfasst";
export const EVENT_GUTHABEN_NICHT_AUSREICHEND = "Guthaben reicht nicht aus. Fehlbetrag: {0} EUR";
export const EVENT_WARENKORB_LEER = "Warenkorb leer";
export const EVENT_WARENKORB_HINZUGEFUEGT = "{0} hinzugefügt";
export const EVENT_WARENKORB_ENTFERNT = "{0} entfernt";
